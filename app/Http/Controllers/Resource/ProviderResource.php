...
class ProviderResource extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.providers.index', compact('providers', 'documents','cancel_rides','rides','fleets'));
    }
    ...
    public function create()
    {
		...
		$fleets = Fleet::all();
        return view('admin.providers.create', compact('services','fleets'));
    }
    ...
    public function edit($id)
    {
        try { 
			...
			return view('admin.providers.edit',compact('provider', 'services','fleets'));
        } catch (Exception $e) {
