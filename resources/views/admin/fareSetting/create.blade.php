...
<!--{{ route('admin.fare.settings.store') }}-->
            <form class="form-horizontal"  action="{{ route('admin.fare.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="" name="from_km" required id="from_km" placeholder="enter in digit (0)" onkeypress="javascript:return isValid(this,event)">
					</div>
				</div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="" name="upto_km" id="upto_km" placeholder="enter in digit (3)" onkeypress="javascript:return isValid(this,event)">
                    </div>
                </div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="" name="price_per_km"  id="price_per_km" onkeypress="javascript:return isValid(this,event)" placeholder="100">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="" name="waiting_price_per_min"  id="waiting_price_per_min" placeholder="4" onkeypress="javascript:return isValid(this,event)">
					</div>
				</div>
				<div class="form-group row">
	...
	$(document).ready(function(){
		 $("body").on("change","#is_rental",function(){
		 	var html = '<label for="store_link_ios" class="col-xs-2 col-form-label">Time duration in minute</label>\
					<div class="col-xs-10">\
						<input class="form-control" required type="text" value="" name="minutes"  id="minute" placeholder="100" >\
					</div>';
