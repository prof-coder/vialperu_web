      ...
      <div class="container-fluid">
         ...
         <div class="col-sm-9 col-xs-9">
            <div class="navbar-right navbar-toggleable-sm collapse" id="collapse-1">
               ...
               <span class="tag tag-success top">{{$users->count()}}</span>
               </a>
               <div class="dropdown-tasks dropdown-menu dropdown-menu-right animated fadeInUp">
                  
                  <div class="t-item">
                     <div class="mb-0-5">
                        <a class="text-black" href="#">Nuevos Usuarios</a>
            ...
            <li class="nav-item dropdown">
               ...
               <!-- <a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false" href="{{ url('/admin/is_read') }}" onclick="event.preventDefault();
               document.getElementById('isRead').submit();"> -->
               <a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false" href="{{ url('/admin/is_read') }}" onclick="ajaxReadData();">               
               ...
               <img src="{{img($provider->avatar)}}" alt="">
                  ...
                  <li class="nav-item dropdown hidden-sm-down">
                     ...
                     <div class="dropdown-menu dropdown-menu-right animated fadeInUp">
                        ...
                        <i class="ti-user mr-0-5"></i> Perfil
                        </a>
                        <a class="dropdown-item" href="{{route('admin.password')}}">
                        <i class="ti-settings mr-0-5"></i> Cambiar Password
                        </a>
                        <div class="dropdown-divider"></div>                        
                        <a class="dropdown-item" href="{{ url('/admin/logout') }}"
                           onclick="event.preventDefault();
                           document.getElementById('logout-form').submit();"><i class="ti-power-off mr-0-5"></i> Salir</a>
                     </div>
                  </li>
               </ul>
            </div>
