   ...
   <div class="custom-scroll">
      ...
      <ul class="sidebar-menu">
         ...
         <li class="with-sub">
            ...
            <span class="s-text">Contratos</span>
            ...
            <ul>
               ...
               <li class="with-sub">
                  ...
                  <span class="s-text">Cuenta Bancarias</span>

                  <span class="s-caret"><i class="fa fa-angle-down"></i></span></a>

                  <ul>

                     <li><a href="{{ url('admin/new_account') }}">Nueva cuenta</a></li>

                     <li><a href="{{ url('admin/approved_account') }}">Cuenta Aprobada</a></li>
               ...
               <li class="with-sub">
                  ...
                  <span class="s-text">Retiros</span>

                  <span class="s-caret"><i class="fa fa-angle-down"></i></span></a>

                  <ul>

                     <li><a href="{{ url('admin/new_withdraw') }}">Nuevo Retiro</a></li>

                     <li><a href="{{ url('admin/approved_withdraw') }}">Retiros Aprobados</a></li>
         ...
         <li class="with-sub">
            ...
            <span class="s-text">Zonas</span>

            </a>

            <ul>

               <li><a href="{{ route('admin.zone.index') }}">Todas las Zonas</a></li>

               <li><a href="{{ route('admin.zone.create') }}">Agreg. Zona</a></li>
         ...
         <li class="with-sub">
          ...
          <li class="with-sub">
            <a href="#" class="waves-effect  waves-light">
               <span class="s-caret"><i class="fa fa-angle-down"></i></span>
               <span class="s-icon"><i class="ti-files"></i></span>
               <span class="s-text">Tax</span>
            </a>
            <ul>
               <li><a href="{{ route('admin.tax.company') }}">Company Tax</a></li>
               <li><a href="{{ route('admin.tax.driver') }}">Driver Tax</a></li>
               <li><a href="{{ route('admin.tax.user') }}">User Tax</a></li>
            </ul>
         </li>
