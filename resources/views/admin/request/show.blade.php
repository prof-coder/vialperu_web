            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <dl class="row">
                        ...
                        @endif
                       <dt><hr></dt>
                       @if($request['lost_item']['id'])
                       <dt class="col-sm-4">Lost Item : </dt>
                        <dd class="col-sm-8">
                            {{$request['lost_item']['lost_item']}}
                        </dd>
                        <dt><hr></dt>
                        <form action="{{ route('admin.lost-update', $request['lost_item']['id']) }}" method="POST">
                        {{ csrf_field() }}
                        ...
                        <select class="form-control" name="status" required="">
                            ...
                            <option value="PENDING" {{($request['lost_item']['status'] == 'PENDING')?'selected':''}}>Pending</option>
                            <option value="SOLVED" {{($request['lost_item']['status'] == 'SOLVED')?'selected':''}}>Solved</option>
