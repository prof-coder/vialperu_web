           ...
           <h5 style="margin-bottom: 2em;"><i class="ti-car"></i>&nbsp;Update Vehicle</h5><hr>
            ...
            <form class="form-horizontal" action="{{url('admin/service_update',$service->id)}}" method="POST" enctype="multipart/form-data" role="form" file="true">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="provider_name" class="col-xs-12 col-form-label">Ride Types</label>
                    <div class="col-xs-10">
                        <?php $rides = explode(',',$service->ride_types); ?>
                        <select name="ride_types[]" required id="ride_type" class="form-control" multiple="multiple">
                            <option value="7" <?php echo in_array(7,$rides)?'selected':'' ?>>Daily</option>
                            <option value="6" <?php echo in_array(6,$rides)?'selected':'' ?>>Rental</option>
                            <option value="4" <?php echo in_array(4,$rides)?'selected':'' ?>>Outstation</option>
                        </select>
                    </div>
                </div>
