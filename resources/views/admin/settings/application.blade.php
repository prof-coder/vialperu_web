...
<!-- 
				<div class="form-group row">
					<label for="referral_point" class="col-xs-2 col-form-label">Referral Point</label>
					<div class="col-xs-12">
						<input class="form-control" type="text" value="{{ Setting::get('referral_point', '') }}" name="referral_point"  id="referral_point" placeholder="Referral Point">
					</div>
				</div> -->
				...
				<div class="form-group row">
					<label for="contact_email" class="col-xs-2 col-form-label"> Address</label>
					<div class="col-xs-12">
						<input class="form-control" type="text" value="{{ Setting::get('address', '') }}" name="address" required id="address" placeholder="Address">
					</div>
				</div>
			   ...
			   <label for="store_link_ios" class="col-xs-4 col-form-label">User Email Validation</label>
				...
				<div class="form-group row">
					<label for="provider_max_money" class="col-xs-4 col-form-label">Provider Wallet Amount(Security money)</label>
					<div class="col-xs-12">
						<input class="form-control" type="text" value="{{ Setting::get('provider_max_money', '') }}" name="provider_max_money" required id="provider_max_money" placeholder="In Second">
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="social_login" class="col-xs-2 col-form-label">Social Login User</label>
					<div class="col-xs-12">
				...
				<div class="form-group row">
					<label for="social_login" class="col-xs-2 col-form-label">Social Login Driver</label>
					<div class="col-xs-12">
