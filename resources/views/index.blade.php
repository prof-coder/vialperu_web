          ...
          @if($val->$meta_des=='index1')
            ...
            <div class="col-md-6">
               ...
               <div class="reasons_btn">
                  <a class="btn btn-default button-shadow" href="{{ url('/PassengerSignin') }}">
         ...
         <div class="col-md-12">
          ...
          @if($val->$meta_des=='index2')
            <div class="col-md-6">
               ...
               <div class="reasons_btn">
                  <a class="btn btn-default button-shadow" href="{{ url('/fare_estimate') }}">
         ...
         <div class="col-md-12">
          ...
          @if($val->$meta_des=='index3')
            ...
            <div class="col-md-6">
               ...
               <div class="reasons_btn">
                  <a class="btn btn-default button-shadow" href="{{ url('/provider/register') }}">
   ...
   <div class="container">
      <div class="therd_banner_text">
         ...
         <div class="community_btn">
            <a href = {{url('/stories')}} class="btn btn-default button-shadow">
...
<div class="unlocking_cities">
   <div class="container">
      <div class="unlocking_text">
         <h3 style="margin-top: 22px;color: white;font-weight: bold; margin-left: -109px;">{{ trans('index.parameter.title5') }}</h3>
      </div>
   </div>
</div>
@endsection
