    ...
    <div class="dash-content">
        ...
        <div class="row no-margin payment">
            ...
            <div class="col-md-12">
                ...
                <h5 class="btm-border"><strong>@lang('user.payment_method')</strong> </h5>
      ...
      <div class="modal-dialog">
        ...
        <form id="payment-form_paypal" action="{{ route('paypal.store') }}" method="POST" >
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="full-primary-btn btn-success box-shadow fare-btn">Add Paypal</button>
