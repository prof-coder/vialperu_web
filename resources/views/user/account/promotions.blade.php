    ...
    <div class="dash-content">
        <div class="row no-margin">
            <div class="col-md-12">
                ...
                <h4 class="page-title"><span class="s-icon"><i class="ti-crown user-sidebaricon" style="color: rgb(0, 0, 0);"></i></span>&nbsp;Promocode</h4>
            </div>
        </div>
        @include('common.notify')
        <div class="row no-margin payment">
            <div class="col-md-12">
                <h5 class="btm-border"><strong>Promocode / Gift Coupons</strong> <a href="#" class="sub-right pull-right" data-toggle="modal" data-target="#add-promotion-modal">@lang('user.add_promocode')</a></h5>
                ...
                @empty
                <div class="pay-option">
                    <h6 class="text-center">No Promocodes applied.</h6>
                </div>
                @endforelse
            </div>
        </div>
