        ...
        <div class="col-lg-4 col-md-6 col-xs-12">
            ...
            <div class="box box-block bg-warning mb-2">
                ...
                <div class="t-content">
                    ...
                    <h4 class="text-uppercase mb-1">Schedule Ride</h4>
            ...
            <div class="dash-content">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-md-12">
                        ...
                        <h4 class="page-title"><span class="s-icon"><i class="fa fa-recycle" style="color: rgb(0, 0, 0);"></i></span>&nbsp;Ride History</h4>
                                ...
                                <tr data-toggle="collapse" data-target="#trip_{{$trip->id}}" class="accordion-toggle collapsed">
                                    ...
                                    <td>
                                        ...
                                        <form action ="{{url('/mytrips/detail')}}">
                                            ...
                                            <button type="submit" style="margin-top: 0px;" class="btn-black btn-rounded fare-btn">Detail</button>
