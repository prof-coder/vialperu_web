                  ...
                  <div class="eats">
                     ...
                     <div class="container">
                        ...
                        <ul>
                           ...
                           <li><a href="{{url(strtolower($service->name))}}">{{ trans('header.mylift') }} {{$service->name}}</a></li>
                           @endforeach
            ...
            <div class="right"  style="float:right;">
               ...
               <ul class="hidden-xs">
                  ...
                  <li>
                    ...
                    <div class="dropdown-menu dropdown-menu-right animated fadeInUp" style="padding: 13px;margin-top: -1px;margin: 0;border: 1px solid #ddd;border-radius: 0;right: 0;left: auto;">
                        <a class="dropdown-item" href="{{url('dashboard')}}" style="display: block;color:#373a3c;text-align: inherit;white-space: nowrap;background: 0 0;border: 0;">
                        <i class="ti-user mr-0-5"></i> Dashboard
                        </a>
                        
                       
                        
                        <a href="{{url('/logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ trans('header.logout') }}</a>
                     </div>
                    ...
                    <a href="#" data-toggle="dropdown" aria-expanded="false">
                     ...
                     {{Auth::guard('provider')->user()->first_name}}
                    ...
                    <div class="dropdown-menu dropdown-menu-right animated fadeInUp" style="padding: 13px;margin-top: -1px;margin: 0;border: 1px solid #ddd;border-radius: 0;right: 0;left: auto;">
                        <a class="dropdown-item" href="{{url('provider/dashboard')}}" style="display: block;color:#373a3c;text-align: inherit;white-space: nowrap;background: 0 0;border: 0;">
                        <i class="ti-user mr-0-5"></i> Dashboard
                        </a>
                        
                       
                        
                        <a href="{{url('provider/logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ trans('header.logout') }}</a>
                     </div>
              ...
              <div class="driver-btn">                            
               ...
               <a style="@if($locale == 'sp') width: 249px; @else width: 180px; @endif" href="{{ url('/provider/register') }}" class="btn btn-default button-shadow">{{ strtoupper(trans('header.li_became_a_driver')) }}</a>                        
              
              </div>
              @endif  
              @endif  
            <!--  <div class="col-md-1 col-xs-3 m-algin-right"> -->
                <div class="sl-nav hidden-xs">
                    <ul>
                        <li>
                            @if($locale == 'ar')
                            ...
                            <ul>
                                <li class="licss"><a href="{{url('lang/en')}}">
                                        ...
                                        <span style="border-top: 0px solid #fff;">{{ trans('header.english-short') }}</span>
                                    </a>
                                </li><br>
                                <li class="licss">
                                    <a href="{{url('lang/ar')}}">
                                        ...
                                        <span style="border-top: 0px solid #fff;">{{ trans('header.arabic-short') }}</span>
                                    </a>
                                </li><br>
                                <li class="licss">
                                    <a href="{{url('lang/fr')}}">
                                        ...
                                        <span style="border-top: 0px solid #fff;">{{ trans('header.french-short') }}</span>
                                    </a>
                                </li><br>
                                <li class="licss">
                                    <a href="{{url('lang/ru')}}">
                                        ...
                                        <span style="border-top: 0px solid #fff;">{{ trans('header.russian-short') }}</span>
                                    </a>
                                </li><br>
                                <li class="licss">
                                    <a href="{{url('lang/sp')}}">
                                        ...
                                        <span style="border-top: 0px solid #fff;">{{ trans('header.spanish-short') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
