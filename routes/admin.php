...
Route::post('changevendorpassword', 'AdminController@changevendorpassword')->name('changevendorpassword');
...
// tax
Route::get('/tax/company', 'AdminController@taxCompany')->name('tax.company');
Route::get('/tax/driver', 'AdminController@taxDriver')->name('tax.driver');
Route::get('/tax/user', 'AdminController@taxUser')->name('tax.user');
